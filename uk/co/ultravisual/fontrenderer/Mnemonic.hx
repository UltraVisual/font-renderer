...
class Mnemonic {
    public static var SVTCA:Int = 0x00;
    public static var SPVTCA:Int = 0x02;
    public static var SFVTCA:Int = 0x04;
    public static var SPVTL:Int = 0x06;
    public static var SFVTL:Int = 0x08;
    public static var SPVFS:Int = 0x0A;
    public static var SFVFS:Int = 0x0B;
    public static var GPV:Int = 0x0C;
    public static var GFV:Int = 0x0D;
    public static var SFVTPV:Int = 0x0E;
    public static var ISECT:Int = 0x0F;
    public static var SRP0:Int = 0x10;
    public static var SRP1:Int = 0x11;
    public static var SRP2:Int = 0x12;
    public static var SZP0:Int = 0x13;
    public static var SZP1:Int = 0x14;
    public static var SZP2:Int = 0x15;
    public static var SZPS:Int = 0x16;
    public static var SLOOP:Int = 0x17;
    public static var RTG:Int = 0x18;
    public static var RTHG:Int = 0x19;
    public static var SMD:Int = 0x1A;
    public static var ELSE:Int = 0x1B;
    public static var JMPR:Int = 0x1C;
    public static var SCVTCI:Int = 0x1D;
    public static var SSWCI:Int = 0x1E;
    public static var SSW:Int = 0x1F;
    public static var DUP:Int = 0x20;
    public static var POP:Int = 0x21;
    public static var CLEAR:Int = 0x22;
    public static var SWAP:Int = 0x23;
    public static var DEPTH:Int = 0x24;
    public static var CINDEX:Int = 0x25;
    public static var MINDEX:Int = 0x26;
    public static var ALIGNPTS:Int = 0x27;
    public static var UTP:Int = 0x29;
    public static var LOOPCALL:Int = 0x2A;
    public static var CALL:Int = 0x2B;
    public static var FDEF:Int = 0x2C;
    public static var ENDF:Int = 0x2D;
    public static var MDAP:Int = 0x2E;
    public static var IUP:Int = 0x30;
    public static var SHP:Int = 0x32;
    public static var SHC:Int = 0x34;
    public static var SHZ:Int = 0x36;
    public static var SHPIX:Int = 0x38;
    public static var IP:Int = 0x39;
    public static var MSIRP:Int = 0x3A;
    public static var ALIGNRP:Int = 0x3C;
    public static var RTDG:Int = 0x3D;
    public static var MIAP:Int = 0x3E;
    public static var NPUSHB:Int = 0x40;
    public static var NPUSHW:Int = 0x41;
    public static var WS:Int = 0x42;
    public static var RS:Int = 0x43;
    public static var WCVTP:Int = 0x44;
    public static var RCVT:Int = 0x45;
    public static var GC:Int = 0x46;
    public static var SCFS:Int = 0x48;
    public static var MD:Int = 0x49;
    public static var MPPEM:Int = 0x4B;
    public static var MPS:Int = 0x4C;
    public static var FLIPON:Int = 0x4D;
    public static var FLIPOFF:Int = 0x4E;
    public static var DEBUG:Int = 0x4F;
    public static var LT:Int = 0x50;
    public static var LTEQ:Int = 0x51;
    public static var GT:Int = 0x52;
    public static var GTEQ:Int = 0x53;
    public static var EQ:Int = 0x54;
    public static var NEQ:Int = 0x55;
    public static var ODD:Int = 0x56;
    public static var EVEN:Int = 0x57;
    public static var IF:Int = 0x58;
    public static var EIF:Int = 0x59;
    public static var AND:Int = 0x5A;
    public static var OR:Int = 0x5B;
    public static var NOT:Int = 0x5C;
    public static var DELTAP1:Int = 0x5D;
    public static var SDB:Int = 0x5E;
    public static var SDS:Int = 0x5F;
    public static var ADD:Int = 0x60;
    public static var SUB:Int = 0x61;
    public static var DIV:Int = 0x62;
    public static var MUL:Int = 0x63;
    public static var ABS:Int = 0x64;
    public static var NEG:Int = 0x65;
    public static var FLOOR:Int = 0x66;
    public static var CEILING:Int = 0x67;
    public static var ROUND:Int = 0x68;
    public static var NROUND:Int = 0x6C;
    public static var WCVTF:Int = 0x70;
    public static var DELTAP2:Int = 0x71;
    public static var DELTAP3:Int = 0x72;
    public static var DELTAC1:Int = 0x73;
    public static var DELTAC2:Int = 0x74;
    public static var DELTAC3:Int = 0x75;
    public static var SROUND:Int = 0x76;
    public static var S45ROUND:Int = 0x77;
    public static var JROT:Int = 0x78;
    public static var JROF:Int = 0x79;
    public static var ROFF:Int = 0x7A;
    public static var RUTG:Int = 0x7C;
    public static var RDTG:Int = 0x7D;
    public static var SANGW:Int = 0x7E;
    public static var AA:Int = 0x7F;
    public static var FLIPPT:Int = 0x80;
    public static var FLIPRGON:Int = 0x81;
    public static var FLIPRGOFF:Int = 0x82;
    public static var SCANCTRL:Int = 0x85;
    public static var SDPVTL:Int = 0x86;
    public static var GETINFO:Int = 0x88;
    public static var IDEF:Int = 0x89;
    public static var ROLL:Int = 0x8A;
    public static var MAX:Int = 0x8B;
    public static var MIN:Int = 0x8C;
    public static var SCANTYPE:Int = 0x8D;
    public static var INSTCTRL:Int = 0x8E;
    public static var PUSHB:Int = 0xB0;
    public static var PUSHW:Int = 0xB8;
    public static var MDRP:Int = 0xC0;
    public static var MIRP:Int = 0xE0;
